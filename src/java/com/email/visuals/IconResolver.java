    ...
    public Node getFolderIcon(String folderName){
        ...
        try {
            if(lowerCaseFolderName.contains("@")){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/email.png")));
            } else if (lowerCaseFolderName.contains("inbox")){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/inbox.png")));
            } else if (lowerCaseFolderName.contains("sent")){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/sent2.png")));
            } else if (lowerCaseFolderName.contains("spam")){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/spam.png")));
            } else if (lowerCaseFolderName.contains("starred")){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/starred.png")));
            } else if (lowerCaseFolderName.contains("trash")){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/trash.png")));
            } else {
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/folder.png")));
            }
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    public Node getAttachmentIcon(String attachmentName){
        ...
        try {
            if(containsExtension(AUDIO_EXTENSIONS, lowerCaseAttachmentName)){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/audio-file.png")));
            } else if (containsExtension(ARCHIVE_EXTENSIONS, lowerCaseAttachmentName)){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/archive.png")));
            } else if (lowerCaseAttachmentName.contains("gif")){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/gif.png")));
            } else if (containsExtension(IMAGE_EXTENSIONS, lowerCaseAttachmentName)){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/image.png")));
            } else if (containsExtension(TEXT_EXTENSIONS, lowerCaseAttachmentName)){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/text-file.png")));
            } else if (containsExtension(VIDEO_EXTENSIONS, lowerCaseAttachmentName)){
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/video.png")));
            } else {
                imageView = new ImageView(new Image(getClass().getResourceAsStream("/com/email/view/icons/file.png")));
            }
        } catch (Exception e) {
            e.printStackTrace();
            return null;
